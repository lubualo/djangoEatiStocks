...
def index(request):
  return render( request, "stockmanager/index.html", {"investments": services.getInvestmentsWithCurrentPrice()} )
...
def add(request):
  if request.method == "POST":
    ...
    return render( request, "stockmanager/add.html", {"addForm": forms.AddStockForm()} )
